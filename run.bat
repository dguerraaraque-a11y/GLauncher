...
REM Copiar carpeta assets (incluyendo fonts) a la salida para asegurar que se carguen
if exist "%BASE_DIR%assets" (
    echo [INFO] Copiando recursos assets y fonts a out...
    xcopy /S /E /Y /I "%BASE_DIR%assets" "%BASE_DIR%out\assets" >nul
)
